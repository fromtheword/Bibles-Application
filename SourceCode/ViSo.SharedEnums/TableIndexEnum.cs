...
namespace ViSo.SharedEnums
{
    ...
    {
        [Description("Not Selected")] None = 0,

        [Description("Company")] Con_Companies = 1,

        [Description("Company Office")] Con_CompanyOffice = 2,

        [Description("Contacts")] Con_Contacts = 3,

        [Description("Sales Order Master")] Sor_Master = 4,

        [Description("System Company")] Ctl_CompanyControl = 5,

        [Description("Inventory Master")] Inv_Master = 6,
